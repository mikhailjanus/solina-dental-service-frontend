          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  to="/register"
                  className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-700 transition-colors font-medium shadow-sm hover:shadow-md"
                >
                  Register
                </Link>
              </div>
              ...
              {user ? (
                ...
                <div className="flex flex-col gap-3 mt-2">
                  ...
                  <Link
                    to="/register"
                    onClick={() => setIsOpen(false)}
                    className="bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors font-medium text-center"
                  >
                    Register
                  </Link>
                </div>
